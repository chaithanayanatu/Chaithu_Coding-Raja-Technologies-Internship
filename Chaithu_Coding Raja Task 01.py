...
class todo:
    def __init__(self,  root):
        ...
        self.lebel = Label(self.root, text='To-Do-List-App',
                           font='ariel, 25 bold', width=10,bd=5, bg='orange', fg='black')
        self.lebel.pack(side='top', fill=BOTH)

        self.lebel2 = Label(self.root, text='Add Task',
                           font='ariel, 18 bold', width=10,bd=5, bg='orange', fg='black')
        self.lebel2.place(x=40, y=54)

        self.lebel3 = Label(self.root, text='Tasks',
                           font='ariel, 18 bold', width=10,bd=5, bg='orange', fg='black')
        self.lebel3.place(x=320, y=54)
